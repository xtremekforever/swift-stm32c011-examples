...
extension RCC {
    ...
    struct APBRSTR2 {
        ...
        /// Set and cleared by software.
        @ReadWrite(bits: 17..<18)
        var tim16rst: TIM16RST

        /// TIM16 timer reset
        /// Set and cleared by software.
        @ReadWrite(bits: 18..<19)
        var tim17rst: TIM17RST
    ...
    struct AHBSMENR {
        ...
        @ReadWrite(bits: 8..<9)
        var flashsmen: FLASHSMEN

        /// SRAM clock enable during Sleep mode
        /// Set and cleared by software.
        @ReadWrite(bits: 9..<10)
        var sramsmen: SRAMSMEN
